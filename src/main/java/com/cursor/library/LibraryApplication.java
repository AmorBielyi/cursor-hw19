...
import com.cursor.library.repositories.UserRepository;
...
public class LibraryApplication {
	...
	public void addUsers(){
		...
		User admin = User.builder()
				...
				.permissions(Set.of(UserPermissions.ROLE_READ, UserPermissions.ROLE_DELETE, UserPermissions.ROLE_WRITE))
				.build();
